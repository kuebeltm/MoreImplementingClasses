...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.hcorner1 = rg.Point(self.intersection_center.x - (self.width /2 ), self.intersection_center.y - (self.letter_thickness /2 ))
        self.hcorner2 = rg.Point(self.intersection_center.x + (self.width /2 ), self.intersection_center.y + (self.letter_thickness /2 ))

        self.h_rect = rg.Rectangle(self.hcorner1, self.hcorner2)
        self.vcorner1 = rg.Point(self.intersection_center.x - (self.letter_thickness / 2), self.intersection_center.y - self.height)
        self.vcorner2 = rg.Point(self.intersection_center.x + (self.letter_thickness / 2), self.intersection_center.y)
        self.v_rect = rg.Rectangle(self.vcorner1, self.vcorner2)
    ...
    def move_by(self, dx, dy):
        ...
        self.hcorner1.x = self.hcorner1.x + dx
        self.hcorner1.y = self.hcorner1.y + dy
        self.hcorner2.x = self.hcorner2.x + dx
        self.hcorner2.y = self.hcorner2.y + dy
        self.vcorner1.x = self.vcorner1.x + dx
        self.vcorner1.y = self.vcorner1.y + dy
        self.vcorner2.x = self.vcorner2.x + dx
        self.vcorner2.y = self.vcorner2.y + dy
